...
public class OpenPersonFromNames {

    @Rule
    public ActivityTestRule<BrowseNamesActivity> activityRule = new ActivityTestRule<>(BrowseNamesActivity.class);
    ...
    public void testOk() {
        ...
        for (int i = 0; i < people.size(); i++) {
            ...
            onData(anything()).inAdapterView(withId(R.id.browseNames_list)).atPosition(i).perform(scrollTo(), click());
